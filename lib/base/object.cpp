...
I2_BASE_API void *operator new(size_t size, const std::nothrow_t& tag) noexcept
{
	GC::Initialize();
	return GC_malloc(size);
}
...
I2_BASE_API void operator delete(void *ptr) noexcept
{
}
...
I2_BASE_API void operator delete(void *ptr, const std::nothrow_t& tag) noexcept
{
}
